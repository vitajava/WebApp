...
<div class="container">
      ...
      <form action="addU.html" method="POST">
          <center>
              <div>
                  <h2>Add User</h2>
              </div>
              <table>
                  ...
                  <tr>
                      <td>Login</td>
                      <td><input required size="30" maxlength="45" type="text" name="login" value=""/></td>
                  </tr>
                  <tr>
                      <td>Password</td>
                      <td><input size="30" maxlength="45" type="text" name="password" value=""/></td>
                  </tr>
                  <tr>
                     <td>First Name</td>
